...
export class InitialMigration1702092278767 implements MigrationInterface {
  name = 'InitialMigration1702092278767';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "expense_category" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, CONSTRAINT "PK_478b68a9314d8787fb3763a2298" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "expense" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "amount" integer NOT NULL, "date" TIMESTAMP NOT NULL, "userId" integer, CONSTRAINT "PK_edd925b450e13ea36197c9590fc" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(

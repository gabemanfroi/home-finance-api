...
export class InitialMigration1702158570571 implements MigrationInterface {
    name = 'InitialMigration1702158570571'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "expense_category" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, CONSTRAINT "PK_478b68a9314d8787fb3763a2298" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "expense" ("id" SERIAL NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying NOT NULL, "amount" integer NOT NULL, "date" TIMESTAMP NOT NULL, "userId" integer NOT NULL, CONSTRAINT "PK_edd925b450e13ea36197c9590fc" PRIMARY KEY ("id"))`);

...
export class InitialMigration1702093946070 implements MigrationInterface {
    name = 'InitialMigration1702093946070'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "expense" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "amount" integer NOT NULL, "date" TIMESTAMP NOT NULL, "userId" integer, CONSTRAINT "PK_edd925b450e13ea36197c9590fc" PRIMARY KEY ("id"))`);
